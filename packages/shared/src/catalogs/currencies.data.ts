...
export const currencies: Currency[] = [
  ...
  { code: 'MXV', name: 'Unidad de Inversión (UDI) mexicana' },
  ...
  { code: 'USN', name: 'Dólar estadounidense (Siguiente día)' },
  { code: 'UYI', name: 'Peso en Unidades Indexadas (Uruguay)' },
  { code: 'UYU', name: 'Peso uruguayo' },
  { code: 'UZS', name: 'Som uzbeko' },
  { code: 'VEF', name: 'Bolívar' },
  { code: 'VES7', name: 'Bolívar soberano' },
  { code: 'VND', name: 'Dong vietnamita' },
  { code: 'VUV', name: 'Vatu' },
  { code: 'WST', name: 'Tala' },
  { code: 'XAF', name: 'Franco CFA de África Central' },
  { code: 'XAG', name: 'Plata (una onza troy)' },
  { code: 'XAU', name: 'Oro (una onza troy)' },
  { code: 'XBA', name: 'Unidad compuesta europea (EURCO)' },
  { code: 'XBB', name: 'Unidad Monetaria europea (E.M.U.-6)' },
  { code: 'XBC', name: 'Unidad europea de cuenta 9 (E.U.A.-9)' },
  { code: 'XBD', name: 'Unidad europea de cuenta 17 (E.U.A.-17)' },
  ...
  { code: 'XPD', name: 'Paladio (una onza troy)' },
  { code: 'XPF', name: 'Franco CFP' },
  { code: 'XPT', name: 'Platino (una onza troy)' },
  { code: 'XSU', name: 'SUCRE' },
  { code: 'XTS', name: 'Reservado para pruebas' },
  { code: 'XUA', name: 'Unidad de cuenta BAD' },
  { code: 'XXX', name: 'Sin divisa' },
